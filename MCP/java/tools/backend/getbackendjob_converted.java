/**
 * MCP Server function for Returns information about a specific job.
 */
...
class Get_Backend_App_Id_Job_Backend_Environment_Name_Job_IdMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Backend_App_Id_Job_Backend_Environment_Name_Job_IdHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("jobId")) {
            queryParams.add("jobId=" + args.get("jobId"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_backend_app_id_job_backend_environment_name_job_id" + queryString;
    ...
    public static MCPServer.Tool createGet_Backend_App_Id_Job_Backend_Environment_Name_Job_IdTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_backend_app_id_job_backend_environment_name_job_id",
            "Returns information about a specific job.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Backend_App_Id_Job_Backend_Environment_Name_Job_IdHandler(config));
    }
