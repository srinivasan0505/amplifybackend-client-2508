/**
 * MCP Server function for Updates a specific job.
 */
...
class Post_Backend_App_Id_Job_Backend_Environment_Name_Job_IdMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Backend_App_Id_Job_Backend_Environment_Name_Job_IdHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("status")) {
            queryParams.add("status=" + args.get("status"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_backend_app_id_job_backend_environment_name_job_id" + queryString;
    ...
    public static MCPServer.Tool createPost_Backend_App_Id_Job_Backend_Environment_Name_Job_IdTool(MCPServer.APIConfig config) {
        ...
        jobIdProperty.put("description", "The ID for the job.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_backend_app_id_job_backend_environment_name_job_id",
            "Updates a specific job.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_Backend_App_Id_Job_Backend_Environment_Name_Job_IdHandler(config));
    }
