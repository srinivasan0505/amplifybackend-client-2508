...
func GetbackendauthHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/backend/%s/auth/%s/details", cfg.BaseURL, appId, backendEnvironmentName)
		...
		var result models.GetBackendAuthResponse
...
func CreateGetbackendauthTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_backend_appId_auth_backendEnvironmentName_details",
		mcp.WithDescription("Gets a backend auth details."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetbackendauthHandler(cfg),
	}
}
