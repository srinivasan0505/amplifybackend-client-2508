...
func UpdatebackendjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateBackendJobrequest
		...
		var result models.UpdateBackendJobResponse
...
func CreateUpdatebackendjobTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_backend_appId_job_backendEnvironmentName_jobId",
		mcp.WithDescription("Updates a specific job."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdatebackendjobHandler(cfg),
	}
}
