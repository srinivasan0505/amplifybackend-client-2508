...
func GetbackendHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetBackendrequest
		...
		url := fmt.Sprintf("%s/backend/%s/details", cfg.BaseURL, appId)
		...
		var result models.GetBackendResponse
...
func CreateGetbackendTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_backend_appId_details",
		mcp.WithDescription("Provides project-level details for your Amplify UI project."),
		...
		mcp.WithString("backendEnvironmentName", mcp.Description("Input parameter: The name of the backend environment.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetbackendHandler(cfg),
	}
}
