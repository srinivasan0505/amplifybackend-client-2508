...
func UpdatebackendconfigHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateBackendConfigrequest
		...
		url := fmt.Sprintf("%s/backend/%s/config/update", cfg.BaseURL, appId)
		...
		var result models.UpdateBackendConfigResponse
...
func CreateUpdatebackendconfigTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_backend_appId_config_update",
		mcp.WithDescription("Updates the AWS resources required to access the Amplify Admin UI."),
		...
		mcp.WithObject("loginAuthConfig", mcp.Description("Input parameter: The request object for this operation.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdatebackendconfigHandler(cfg),
	}
}
