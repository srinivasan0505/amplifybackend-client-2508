...
func GetbackendapimodelsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/backend/%s/api/%s/getModels", cfg.BaseURL, appId, backendEnvironmentName)
		...
		var result models.GetBackendAPIModelsResponse
...
func CreateGetbackendapimodelsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_backend_appId_api_backendEnvironmentName_getModels",
		mcp.WithDescription("Gets a model introspection schema for an existing backend API resource."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetbackendapimodelsHandler(cfg),
	}
}
