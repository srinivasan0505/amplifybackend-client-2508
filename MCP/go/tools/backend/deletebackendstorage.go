...
func DeletebackendstorageHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteBackendStoragerequest
		...
		url := fmt.Sprintf("%s/backend/%s/storage/%s/remove", cfg.BaseURL, appId, backendEnvironmentName)
		...
		var result models.DeleteBackendStorageResponse
...
func CreateDeletebackendstorageTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_backend_appId_storage_backendEnvironmentName_remove",
		mcp.WithDescription("Removes the specified backend storage resource."),
		...
		mcp.WithString("serviceName", mcp.Required(), mcp.Description("Input parameter: The name of the storage service.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeletebackendstorageHandler(cfg),
	}
}
