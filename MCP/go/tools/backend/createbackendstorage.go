...
func CreatebackendstorageHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateBackendStoragerequest
		...
		url := fmt.Sprintf("%s/backend/%s/storage", cfg.BaseURL, appId)
		...
		var result models.CreateBackendStorageResponse
...
func CreateCreatebackendstorageTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_backend_appId_storage",
		mcp.WithDescription("Creates a backend storage resource."),
		...
		mcp.WithObject("resourceConfig", mcp.Required(), mcp.Description("Input parameter: The resource configuration for creating backend storage.")),
		mcp.WithString("resourceName", mcp.Required(), mcp.Description("Input parameter: The name of the storage resource.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    CreatebackendstorageHandler(cfg),
	}
}
