...
func GetbackendstorageHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetBackendStoragerequest
		...
		url := fmt.Sprintf("%s/backend/%s/storage/%s/details", cfg.BaseURL, appId, backendEnvironmentName)
		...
		var result models.GetBackendStorageResponse
...
func CreateGetbackendstorageTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_backend_appId_storage_backendEnvironmentName_details",
		mcp.WithDescription("Gets details for a backend storage resource."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetbackendstorageHandler(cfg),
	}
}
