...
func DeletebackendauthHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/backend/%s/auth/%s/remove", cfg.BaseURL, appId, backendEnvironmentName)
		...
		var result models.DeleteBackendAuthResponse
...
func CreateDeletebackendauthTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_backend_appId_auth_backendEnvironmentName_remove",
		mcp.WithDescription("Deletes an existing backend authentication resource."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletebackendauthHandler(cfg),
	}
}
