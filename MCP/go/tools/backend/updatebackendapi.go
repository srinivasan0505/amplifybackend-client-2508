...
func UpdatebackendapiHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/backend/%s/api/%s", cfg.BaseURL, appId, backendEnvironmentName)
		...
		var result models.UpdateBackendAPIResponse
...
func CreateUpdatebackendapiTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_backend_appId_api_backendEnvironmentName",
		mcp.WithDescription("Updates an existing backend API resource."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdatebackendapiHandler(cfg),
	}
}
