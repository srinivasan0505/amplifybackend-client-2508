...
func GetbackendapiHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/backend/%s/api/%s/details", cfg.BaseURL, appId, backendEnvironmentName)
		...
		var result models.GetBackendAPIResponse
...
func CreateGetbackendapiTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_backend_appId_api_backendEnvironmentName_details",
		mcp.WithDescription("Gets the details for a backend API."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetbackendapiHandler(cfg),
	}
}
